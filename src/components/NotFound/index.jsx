...
//                 <Heading
//                   className={classNames('page-404_title', `page-404_title--${status}`)}
//                   level={0}
//                 >
//                   404
//                 </Heading>
...
//                 loop
//                 playsInline
//                 className={classNames('page-404_video', `page-404_video--${status}`)}
//                 poster={NotfoundPoster}
//               >
//                 <source src={Notfound} type="video/mp4" />
//               </video>
//               <a
//                 className={classNames('page-404_credit', `page-404_credit--${status}`)}
